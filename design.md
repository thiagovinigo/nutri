...
| `--primary-color` | `#a855f7` (Purple 600) | `#a855f7` (Purple 600) | Marca Nutrivvo, botões primários, destaque |
| `--primary-shadow` | `#3949ab` (Indigo 600) | `#3949ab` (Indigo 600) | Sombra de marca, estado ativo |
...
| `--crm-primary` | `#a855f7` (Purple 600)| `#a855f7` (Purple 600)| Calls to Action primários |
| `--crm-accent` | `#3949ab` (Indigo 600)| `#3949ab` (Indigo 600) | Destaques textuais, ícones |
| `--crm-accent-soft` | `#ede4fb` (Purple Tint)| `#2e1065` (Purple Dark Tint)| Fundos de alerta positivo |
